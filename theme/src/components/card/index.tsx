...
export const Card: FunctionComponent<ICardProps> = ({
  ...
  <StyledArticle style={style}>
    <StyledCard to={path}>
      {/* TODO: Oh boy...*/}
      {featuredImage && featuredImage.fixed && <FeaturedImage fixed={featuredImage.fixed} halfImage={halfImage} />}
      {featuredImage && featuredImage.sizes && <FeaturedImage sizes={featuredImage.sizes} halfImage={halfImage} />}
